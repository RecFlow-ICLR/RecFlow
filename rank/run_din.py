...
from dataset import Rank_Train_Dataset
...
if __name__ == '__main__':
  ...
  model = DIN(args.emb_dim, args.seq_len, device, max_candidate_cnt, id_cnt_dict).to(device)
  ...
  for epoch in range(args.epochs):
    for n_day in range(num_of_train_csv):
      train_dataset = Rank_Train_Dataset(
  ...
  path_to_save_model=f"./checkpoints/bs-{args.batch_size}_lr-{args.lr}_{args.tag}.pkl"
